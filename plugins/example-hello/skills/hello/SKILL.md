---
name: hello
description: Greet the user with a friendly message that includes context about their current project directory and any open files. Invoke when the user says hello, hi, or greet, or runs /hello.
argument-hint: [name]
user-invocable: true
...
1. Say hello to the user (use their name from $ARGUMENTS if provided).
